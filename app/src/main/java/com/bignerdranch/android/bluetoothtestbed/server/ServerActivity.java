...
//                        | BluetoothGattCharacteristic.PROPERTY_NOTIFY,
    ...
    private void notifyCharacteristic(byte[] value, UUID uuid) {
        mHandler.post(() -> {
            ...
            log("\nNotify value :- "+StringUtils.stringFromBytes(value));
            log("--------------------------------------------------------------------------------------------------------\n\n");
    ...
    private void sendReverseMessage(byte[] message) {
        mHandler.post(() -> {
            ...
            Log.d("Message","\nSending: " + StringUtils.byteArrayInHexFormat(response));
            log("\nSending message:-"+ StringUtils.stringFromBytes(response));
    ...
    private class GattServerCallback extends BluetoothGattServerCallback {
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device,
            ...
            super.onCharacteristicWriteRequest(device,
                    ...
                    offset,
                    value);
            Log.d("Message","onCharacteristicWriteRequest" + characteristic.getUuid().toString()
                    + "\nReceived: " + StringUtils.byteArrayInHexFormat(value));

            log("\nReceived Value : " + StringUtils.stringFromBytes(value));
